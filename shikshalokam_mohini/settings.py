...
CRONJOBS = [
    ('30 3 * * *',
     'cd /home/ubuntu/shikshalokam-mohini-service && '
     '/home/ubuntu/mohini-env/bin/python manage.py runscript handle_village_ingestion_cron >> /tmp/handle_village_ingestion_cron.log 2>&1'),

    ('30 4 * * *',
     'cd /home/ubuntu/shikshalokam-mohini-service && '
     '/home/ubuntu/mohini-env/bin/python manage.py runscript handle_non_english_fix_cron >> /tmp/handle_non_english_fix_cron.log 2>&1'),
]
