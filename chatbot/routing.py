...
from .consumers.async_chaupal_consumer_v2 import AsyncShikshalokamChaupalV2Consumer
...
websocket_urlpatterns = [
    ...
    re_path(r"ws/shikshalokam_chaupal/v2/$", AsyncShikshalokamChaupalV2Consumer.as_asgi()),
