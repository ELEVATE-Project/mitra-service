...
def get_first_page_html_kannada(profile, story, project):
    ...
    author = translate_field(
        voice_provider=voice_provider, message_body=author, target_language='kn'
    )
    address_string = translate_field(
        voice_provider=voice_provider, message_body=address_string, target_language='kn'
    )
