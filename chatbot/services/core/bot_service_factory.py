...
from chatbot.services.strategies.common_strategy_new import CommonBotStrategyNew
...
class BotServiceFactory:
    ...
    _strategies = {
        ...
        'common_new': CommonBotStrategyNew,
    }

    @classmethod
    def create_bot_service(cls, bot_type, route=None, extra_params=None):
